        ...
        <TabsContent value="weekly" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <CardContent>
              <div className="flex flex-col space-y-6 p-4 bg-white rounded-lg shadow-lg">
  {/* Top Section with Progress and Punch Details */}
  <div className="flex flex-col md:flex-row md:space-x-6">
    {/* Progress Circle */}
    <div className="relative w-48 h-48 flex justify-center items-center mx-auto md:mx-0">
      <Progress value={progress} className="w-48 h-48 -rotate-90" />
    ...
    {/* Punch Details */}
    <div className="space-y-3 w-full md:w-48 mx-auto md:mx-0 mt-10 md:mt-8">
